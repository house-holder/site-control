...
It's also been a `bash` learning journey for me, and I am adding complexity for complexity's sake to get my feet wet with this utility script.

## Milestone Goals:

- [x] Can start and stop a development version of the webapp (Vite + Go in a tmux session) via the script
